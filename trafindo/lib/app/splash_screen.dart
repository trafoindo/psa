...
import 'package:trafindo/walkthrough/walkthrough_screen.dart'; // Import Firebase Auth
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage(
                'assets/images/background.jpg'), // Change to your image path
            fit: BoxFit.cover,
          ),
        ),
        child: Padding(
